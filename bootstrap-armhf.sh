...
cd /opt
wget https://raw.githubusercontent.com/SimonAnnetts/OVHStorageServer/master/xo-server-armhf.tar.bz2
tar -jxf xo-server-armhf.tar.bz2
wget https://raw.githubusercontent.com/SimonAnnetts/OVHStorageServer/master/xo-web-armhf.tar.bz2
tar -jxf xo-web-armhf.tar.bz2
